/**
 * SHINORA VECTOR ICON SERVICE (HỆ THỐNG BIỂU TƯỢNG VECTOR SVG CAO CẤP)
 * Chuẩn thiết kế: Lucide / Apple SF Symbols (Stroke: 1.75px, bo tròn, thích ứng theme currentColor)
 */
...
const Icons = {
  registry: {
    ...
    history: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline><path d="M2 12a10 10 0 1 1 3.5 7.5"></path></svg>`,
    manage: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1.5"></rect><rect x="14" y="3" width="7" height="7" rx="1.5"></rect><rect x="14" y="14" width="7" height="7" rx="1.5"></rect><rect x="3" y="14" width="7" height="7" rx="1.5"></rect></svg>`,
    ...
    contact: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>`,
    island: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="7" width="18" height="10" rx="5"></rect><circle cx="8" cy="12" r="1.5" fill="currentColor"></circle></svg>`,
    terms: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>`,
    ...
    crown: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 4l3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14v2H5v-2z"></path></svg>`,
    ...
    student: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"></path><path d="M6 12v5c3 3 9 3 12 0v-5"></path></svg>`,
    key: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 2-2 2m-1.5 1.5L14 9l-1.5-1.5L11 9l-1.5-1.5L8 9a5.5 5.5 0 1 0 7.78 7.78L21 12l2-2v-4l-2-2z"></path></svg>`,
    ...
    refresh: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 2v6h-6M21.34 15.57a10 10 0 1 1-.57-8.38l5.67-5.67"></path></svg>`,
    ...
    flame: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 3.5z"></path></svg>`,
    ...
    timer: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>`,
    calculator: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"></rect><line x1="8" x2="16" y1="6" y2="6"></line><line x1="16" x2="16" y1="14" y2="18"></line><path d="M16 10h.01"></path><path d="M12 10h.01"></path><path d="M8 10h.01"></path><path d="M12 14h.01"></path><path d="M8 14h.01"></path><path d="M12 18h.01"></path><path d="M8 18h.01"></path></svg>`,
    helpCircle: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>`,
    ...
    laptop: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="12" rx="2"></rect><line x1="2" y1="20" x2="22" y2="20"></line></svg>`,
    ...
    sparkleStar: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>`
  },

  MEMBER_AVATARS: [
    { id: "avatar-student", name: "Sinh Viên", icon: "student", bg: "linear-gradient(135deg, #0284c7 0%, #2563eb 100%)", shadow: "rgba(2, 132, 199, 0.35)" },
    { id: "avatar-coder", name: "Lập Trình", icon: "keyboard", bg: "linear-gradient(135deg, #8b5cf6 0%, #6366f1 100%)", shadow: "rgba(139, 92, 246, 0.35)" },
    { id: "avatar-scholar", name: "Học Giả", icon: "bookOpen", bg: "linear-gradient(135deg, #10b981 0%, #059669 100%)", shadow: "rgba(16, 185, 129, 0.35)" },
    { id: "avatar-star", name: "Thủ Khoa", icon: "star", bg: "linear-gradient(135deg, #f59e0b 0%, #d97706 100%)", shadow: "rgba(245, 158, 11, 0.35)" },
    { id: "avatar-genius", name: "Thiên Tài", icon: "sparkles", bg: "linear-gradient(135deg, #ec4899 0%, #be185d 100%)", shadow: "rgba(236, 72, 153, 0.35)" },
    { id: "avatar-science", name: "Nghiên Cứu", icon: "database", bg: "linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)", shadow: "rgba(6, 182, 212, 0.35)" },
    { id: "avatar-target", name: "Mục Tiêu", icon: "target", bg: "linear-gradient(135deg, #ef4444 0%, #b91c1c 100%)", shadow: "rgba(239, 68, 68, 0.35)" },
    { id: "avatar-flame", name: "Chiến Binh", icon: "flame", bg: "linear-gradient(135deg, #f97316 0%, #ea580c 100%)", shadow: "rgba(249, 115, 22, 0.35)" },
    { id: "avatar-crown", name: "Thủ Lĩnh", icon: "crown", bg: "linear-gradient(135deg, #eab308 0%, #ca8a04 100%)", shadow: "rgba(234, 179, 8, 0.35)" },
    { id: "avatar-shield", name: "Bảo Mật", icon: "shieldCheck", bg: "linear-gradient(135deg, #14b8a6 0%, #0f766e 100%)", shadow: "rgba(20, 184, 166, 0.35)" },
    { id: "avatar-zen", name: "Tập Trung", icon: "moon", bg: "linear-gradient(135deg, #64748b 0%, #334155 100%)", shadow: "rgba(100, 116, 139, 0.35)" },
    { id: "avatar-zap", name: "Tốc Độ", icon: "zap", bg: "linear-gradient(135deg, #a855f7 0%, #7e22ce 100%)", shadow: "rgba(168, 85, 247, 0.35)" }
  ],

  /**
   * Lấy mã HTML SVG theo tên
   * @param {string} name Tên icon
   * @param {number} size Kích thước px (mặc định 16px)
   * @param {string} className Class CSS đi kèm
   * @param {string} color Màu sắc (mặc định currentColor)
   */
  get(name, size = 16, className = "", color = "") {
    let svg = this.registry[name] || this.registry.sparkles;
    let style = "";
    if (color) style = `style="color:${color};"`;
    
    // Thay thế width & height
    svg = svg.replace('<svg', `<svg class="svg-icon ${className}" width="${size}" height="${size}" ${style}`);
    return svg;
  },

  /**
   * Render avatar thành viên dạng huy hiệu gradient tròn cao cấp
  ...
  renderAvatar(avatarKey, size = 32, role = "student", customClass = "") {
    if (!avatarKey || avatarKey === "guest") {
      return `
        <div class="user-avatar-badge guest ${customClass}" style="width:${size}px; height:${size}px; border-radius:50%; background:var(--surface-subtle); color:var(--text-tertiary); border:1.5px dashed var(--border); display:inline-flex; align-items:center; justify-content:center; flex-shrink:0;">
          ${this.get('user', Math.round(size * 0.52))}
        </div>
      `;
    }
    ...
    return `
      <div class="user-avatar-badge ${customClass}" style="width:${size}px; height:${size}px; border-radius:50%; background:${av.bg}; color:#fff; display:inline-flex; align-items:center; justify-content:center; box-shadow:0 2px 8px ${av.shadow}; flex-shrink:0;" title="${av.name}">
        ${this.get(av.icon, Math.round(size * 0.52), '', '#ffffff')}
      </div>
    `;
  }
};
